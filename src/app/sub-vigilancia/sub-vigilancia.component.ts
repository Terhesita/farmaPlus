...
@Component({
  selector: 'app-sub-vigilancia',
  templateUrl: './sub-vigilancia.component.html',
  styleUrls: ['./sub-vigilancia.component.css']
})
export class SubVigilanciaComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/VigilanciaMedica").subscribe(res=>{
