...
@Component({
  selector: 'app-sub-respiratorio',
  templateUrl: './sub-respiratorio.component.html',
  styleUrls: ['./sub-respiratorio.component.css']
})
export class SubRespiratorioComponent implements OnInit {
