...
@Component({
  selector: 'app-sub-cosmeticos',
  templateUrl: './sub-cosmeticos.component.html',
  styleUrls: ['./sub-cosmeticos.component.css']
})
export class SubCosmeticosComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Cosmeticos").subscribe(res=>{
