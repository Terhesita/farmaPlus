...
@Component({
  selector: 'app-cuidado-p',
  templateUrl: './cuidado-p.component.html',
  styleUrls: ['./cuidado-p.component.css']
})
export class CuidadoPComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/ProductosCPersonal").subscribe(res=>{
