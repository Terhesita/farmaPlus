...
@Component({
  selector: 'app-sub-otros',
  templateUrl: './sub-otros.component.html',
  styleUrls: ['./sub-otros.component.css']
})
export class SubOtrosComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Otros").subscribe(res=>{
