...
@Component({
  selector: 'app-sub-jabones',
  templateUrl: './sub-jabones.component.html',
  styleUrls: ['./sub-jabones.component.css']
})
export class SubJabonesComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Jabones").subscribe(res=>{
