...
@Component({
  selector: 'app-sub-arespiratorio',
  templateUrl: './sub-arespiratorio.component.html',
  styleUrls: ['./sub-arespiratorio.component.css']
})
export class SubARespiratorioComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Respiratorio").subscribe(res=>{
