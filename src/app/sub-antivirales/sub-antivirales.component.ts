...
@Component({
  selector: 'app-sub-antivirales',
  templateUrl: './sub-antivirales.component.html',
  styleUrls: ['./sub-antivirales.component.css']
})
export class SubAntiviralesComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Antivirales").subscribe(res=>{
