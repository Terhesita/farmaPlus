...
@Component({
  selector: 'app-sub-hintima',
  templateUrl: './sub-hintima.component.html',
  styleUrls: ['./sub-hintima.component.css']
})
export class SubHIntimaComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/HigieneIntima").subscribe(res=>{
