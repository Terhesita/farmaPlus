...
@Component({
  selector: 'app-sub-repelente',
  templateUrl: './sub-repelente.component.html',
  styleUrls: ['./sub-repelente.component.css']
})
export class SubRepelenteComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Repelente").subscribe(res=>{
