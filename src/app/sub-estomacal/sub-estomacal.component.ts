...
@Component({
  selector: 'app-sub-estomacal',
  templateUrl: './sub-estomacal.component.html',
  styleUrls: ['./sub-estomacal.component.css']
})
export class SubEstomacalComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Estomacal").subscribe(res=>{
