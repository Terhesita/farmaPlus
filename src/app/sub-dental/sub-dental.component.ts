...
@Component({
  selector: 'app-sub-dental',
  templateUrl: './sub-dental.component.html',
  styleUrls: ['./sub-dental.component.css']
})
export class SubDentalComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Dental").subscribe(res=>{
