...
@Component({
  selector: 'app-sub-alcohol',
  templateUrl: './sub-alcohol.component.html',
  styleUrls: ['./sub-alcohol.component.css']
})
export class SubAlcoholComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/AlcoholAguAantiseptico").subscribe(res=>{
