...
@Component({
  selector: 'app-sub-parasitos',
  templateUrl: './sub-parasitos.component.html',
  styleUrls: ['./sub-parasitos.component.css']
})
export class SubParasitosComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/ContraParasitos").subscribe(res=>{
