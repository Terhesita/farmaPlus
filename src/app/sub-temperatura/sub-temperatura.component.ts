...
@Component({
  selector: 'app-sub-temperatura',
  templateUrl: './sub-temperatura.component.html',
  styleUrls: ['./sub-temperatura.component.css']
})
export class SubTemperaturaComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Temperatura").subscribe(res=>{
