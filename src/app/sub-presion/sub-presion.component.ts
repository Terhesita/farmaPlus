...
@Component({
  selector: 'app-sub-presion',
  templateUrl: './sub-presion.component.html',
  styleUrls: ['./sub-presion.component.css']
})
export class SubPresionComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Presion").subscribe(res=>{
