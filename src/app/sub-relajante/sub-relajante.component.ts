...
@Component({
  selector: 'app-sub-relajante',
  templateUrl: './sub-relajante.component.html',
  styleUrls: ['./sub-relajante.component.css']
})
export class SubRelajanteComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Relajantes").subscribe(res=>{
