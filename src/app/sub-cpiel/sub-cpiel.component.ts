...
@Component({
  selector: 'app-sub-cpiel',
  templateUrl: './sub-cpiel.component.html',
  styleUrls: ['./sub-cpiel.component.css']
})
export class SubCPielComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/CuidadoPiel").subscribe(res=>{
