...
@Component({
  selector: 'app-s-sexual',
  templateUrl: './s-sexual.component.html',
  styleUrls: ['./s-sexual.component.css']
})
export class SSexualComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/ProductosSaludS").subscribe(res=>{
