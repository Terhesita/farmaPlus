...
@Component({
  selector: 'app-sub-algodon',
  templateUrl: './sub-algodon.component.html',
  styleUrls: ['./sub-algodon.component.css']
})
export class SubAlgodonComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Algodon").subscribe(res=>{
