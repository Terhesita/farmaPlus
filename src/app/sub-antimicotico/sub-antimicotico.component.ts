...
@Component({
  selector: 'app-sub-antimicotico',
  templateUrl: './sub-antimicotico.component.html',
  styleUrls: ['./sub-antimicotico.component.css']
})
export class SubAntimicoticoComponent implements OnInit {
  respuesta:any [] = [];
  productos:any [];
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Antimicotico").subscribe(res=>{
