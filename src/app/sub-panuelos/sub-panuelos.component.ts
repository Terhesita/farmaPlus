...
@Component({
  selector: 'app-sub-panuelos',
  templateUrl: './sub-panuelos.component.html',
  styleUrls: ['./sub-panuelos.component.css']
})
export class SubPanuelosComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Panuelos").subscribe(res=>{
