...
@Component({
  selector: 'app-sub-glucosa',
  templateUrl: './sub-glucosa.component.html',
  styleUrls: ['./sub-glucosa.component.css']
})
export class SubGlucosaComponent implements OnInit {
  ...
  getProductos(){
    ...
    this.authService.categoria(datos,"/Glucosa").subscribe(res=>{
